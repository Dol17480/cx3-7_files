...
/***/ function(module, exports, __webpack_require__) {
	...
	window.onload = function () {
	  ReactDOM.render(React.createElement(PiggyBank, { title: 'Beth\'s piggy bank', colour: 'red', owner: 'David' }), document.getElementById('app'));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PiggyBank = React.createClass({
	  ...
	  takeFromSavings: function takeFromSavings() {
	    this.setState({
	      total: this.state.total - this.state.depositAmount
	    });
	  },
	
	  updateDepositAmount: function updateDepositAmount(event) {
	    this.setState({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        "button",
	        { onClick: this.takeFromSavings },
	        "Deposit deducted!"
	      ),
	      React.createElement("input", { value: this.state.depositAmount, onChange: this.updateDepositAmount })
	    );
	  }
	});
